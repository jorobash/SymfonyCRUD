...
class ToDoController extends Controller
{
    ...
    {  
     ...
     /**
     * @Route("/todo/create", name="toto_create")
     */
    ...
    {  
        ...
        $form = $this->createFormBuilder($todo)
            ...
            ->add('priority',ChoiceType::class, array('choices' => array('Low' => 'Low','Normal' => 'Normal','Higth' => 'Higth'),'attr' => array('class' => 'form-control','style' => 'margin-bottom:15px')))
    ...
    /**
     * @Route("/todo/details/{id}", name="toto_details")
     */
    ...
    /**
     * @Route("/todo/edit/{id}", name="toto_edit")
     */
    ...
    {  
     ...
     /**
     * @Route("/todo/delete/{id}", name="toto_delete")
     */
